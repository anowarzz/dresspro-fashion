      ...
      <div className="flex items-center justify-between">
        ...
        <div className="lg:hidden">
          ...
          >
            ...
            <div className={`${isMenuOpen ? "absolute top-0 left-0 right-0 transition-all ease-in w-[100%] duration-500 h-full" : "absolute -top-96 -left-0 h-full transition-opacity  ease-out w-full duration-500" } `}>
