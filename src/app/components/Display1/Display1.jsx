...
const Display1 = () => {
    return (
     ...
     <>
     <div className={`h-48 lg:h-64 lg:hidden ${styles.phoneDisplay} flex justify-center items-center`}>
     ...
     <div className={`h-48 lg:h-64 hidden lg:block ${styles.pcDisplay} lg:flex lg:justify-center lg:items-center`}>
        <h2 className='font-bold text-white text-2xl md:text-4xl lg:text-5xl text-center '><span className='text-[#b3ec07]'>Unlocking</span>  the World of Fashionable Possibilities.</h2>
        </div>
